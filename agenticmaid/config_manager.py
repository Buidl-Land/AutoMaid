...
class ConfigManager:
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        if not os.path.exists(self.config_path):
            # Return empty config if file doesn't exist, allowing the system to work
            # with environment variables or programmatic configuration
            config = {}
        else:
...
# Now that ConfigManager handles missing config files gracefully, we can initialize it
