...
# To run this application (from the project root directory, ensuring AgenticMaid/ is in PYTHONPATH or current dir):
# uvicorn AgenticMaid.api:app --reload
# Example: PYTHONPATH=. uvicorn AgenticMaid.api:app --reload
# Or if AgenticMaid is installed as a package.